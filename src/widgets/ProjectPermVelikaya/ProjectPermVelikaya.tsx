                ...
                <Project project={PROJECTS[7]}>
                    <div className="project-card__conteiner">
                        <p className="project-card__text">
                            ...
                            Прикамья вокруг традиционных культурных и
                            духовно-нравственных ценностей. Ключевая идея
                            Проекта: «мы разные, но у нас общая история, единое
                            настоящее, мы в ответе за наше будущее!» Целевая
                            группа – учащиеся 8-11 классов образовательных
                            организаций Пермского края, студенты среднего
                            профессионального образования в возрасте 14 – 20
                            лет. В реализации проекте участвуют 8
                            муниципалитетов Прикамья, где компактно проживают
                            представители разных национальностей, город Пермь,
                            Коми-Пермяцкий национальный округ (Кудымкар),
                            Куединский, Ординский, Бардымский МР. (татары,
                            башкиры, удмурты), Суксунский МР (марийцы),
                        ...
                        <p className="project-card__text">
                            ...
                            лидерские команды «на местах», создано в ВКонтакте
                            интернет-сообщество «Солнечный круг» с целью
                            размещения актуального позитивного культурного
                            контента, обсуждения «острых» вопросов
                            межнационального общения в молодёжной среде
                            Прикамья. Интернет-сообщество «Солнечный круг»
                            входит в команду организаторов - идеологов Краевого
                            молодёжного Фестиваля «Парма многоликая». 2 этап -
                            ключевое мероприятие - краевой Фестиваль
                            национальных культур «Парма многоликая» предполагает
                            создание интерактивного пространства для
                        ...
                        <p className="project-card__text">
                            ...
                            культуры разных народов как основы мироустройства.
                            Проект даёт возможность молодым людям разных
                            национальностей Прикамья включиться в активные
                            социальные практики на общее благо, получить
                        ...
                        <p className="project-card__text">
                            ...
                            общественных объединений. Это не только традиционные
                            народности (татары, удмурты, башкиры, коми, немцы),
                            но и мигранты, представляющие народы Средней Азии,
                            Кавказа, Украины, Индии, Африки (студенты ВУЗов).
                        ...
                        <p className="project-card__text">
                            ...
                            отношению к представителям «другой» национальности.
                            Полученные в ходе мониторинга данные позволяют
                            сделать определённые выводы: первое для молодёжи
                            Прикамья тема этнокультурного многообразия родного
                            края представляет особый интерес; второе есть
                            основания говорить о низком уровне этнокультурной
                        ...
                        <p className="project-card__text">
                            ...
                            «национальный культурный код» помогает «вписаться»
                            молодому человеку в реалии современного мира? И
                            когда мешает справиться с вызовами нашего времени?
                            Это актуальная повестка для этнокультурной среды
                            многонационального Прикамья. Сегодня, как никогда,
                            возможности «молодёжной дипломатии» востребованы,
                            глобальный МИР во многом зависит от мировоззрения
                            тех, кому сегодня еще нет восемнадцати! Проект с
                            участием молодёжи предполагает широкое использование
