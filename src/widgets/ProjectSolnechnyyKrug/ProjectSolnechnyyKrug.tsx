                ...
                <Project
                    child={
                        <div className="project-card__conteiner">
                            ...
                            <p className="project-card__text">
                                Поставленная Цель достигается в рамках
                                организации и проведения выездного двухдневного
                                молодежного фестиваля национальных культур
                                Пермского края «Солнечный круг» с приглашением
                                гостей из других городов России и реализации «на
                                местах» добровольческих, миротворческих
                                проектов, созданных в рамках Фестиваля.
                            </p>
                            <article className="project-card__article">
                                ...
                                <ul className="project-card__list">
                                    ...
                                    <li className="project-card__li">
                                        ...
                                        организаций в сфере изучения и
                                        популяризации культуры, традиций и
                                        истории народов, проживающих в Пермском
                                        крае;
                                    </li>
                                    <li className="project-card__li">
                            ...
                            <article className="project-card__article">
                                ...
                                <ol className="project-card__numlist project-card__article">
                                    <li className="project-card__li">
                                        Создать интерактивную молодежную
                                        площадку для тесного взаимодействия
                                        представителей разных культур Пермского
                                        края в сфере добровольческих инициатив,
                                        культуры, спорта, ораторского искусства.
                                        Фестиваль должен стать стартом для
                                        продолжения взаимодействия молодежных
                                        групп и объединений Пермского края.
                                    </li>
                                    <li className="project-card__li">
                                        В рамках фестиваля провести:
                                        <ul className="project-card__list">
                                            <li className="project-card__li">
                                                творческие мастерские по
                                                знакомству с национальными
                                                культурами Пермского края;
                                            </li>
                                            <li className="project-card__li">
                                                игры на сплочение
                                            ...
                                            <li className="project-card__li">
                                                ...
                                                культуры и традиционных
                                                ценностей народов современного
                                                Прикамья для укрепления
                                                межнационального и
                                                межконфессионального согласия;
                                            </li>
                                            <li className="project-card__li">
                                                организовать работу
                                                коммуникационных площадок,
                                                направленных на преодоление
                                                барьеров в межличностных
                                                отношениях: решение кейсов с
                                                примерами из жизни, основанных
                                                на разнообразии национальной
                                                ментальности, выработке
                                                конструктивных решений проблем
                                                для формирования толерантности в
                                                молодежной среде;
                                            </li>
                                            <li className="project-card__li">
                                    ...
                                    <li className="project-card__li">
                                        ...
                                        единого информационного банка «Наш
                                        Пермский край, нам вместе за руку идти».
                                    </li>
                                    <li className="project-card__li">
                            ...
                            <article className="project-card__article">
                                ...
                                <p className="project-card__text">
                                    ...
                                    взаимодействия межнациональных молодежных
                                    групп и объединений Пермского края и городов
                                    России.
                                </p>
                                <ol className="project-card__numlist project-card__article">
                                    <li className="project-card__li">
                                        В молодежном фестивале приняли участие
                                        более 200 человек, молодежь Пермского
                                        края и гости края.
                                    </li>
                                    <li className="project-card__li">
