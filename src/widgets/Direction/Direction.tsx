    ...
    return (
        <section className="direction">
            <ul className="direction__conteiner">
                ...
                <Member
                    image="bol"
                    text="член Правления, учитель Гимназии №5 города Перми, Заслуженный учитель РФ"
                    alt="Большакова Татьяна Владимировна"
                />
                <Member
                    image="bob"
                    text="член Правления, ландшафтный дизайнер, 
                    член Совета ПРООУ «Ассоциация «ЛУЧ», 
                ...
                <Member
                    image="vin"
                    text="член Правления, председатель Попечительского совета, 
                ...
                <Member
                    image="ast"
                    text="член Правления, графический дизайнер, бренд-дизайнер, 
                    внучка Героя Советского Союза В.М. Астафьева"
                    alt="Астафьева Олеся Владимировна"
                />
                <Member
                    image="iko"
                    text="член Правления, член Совета ПРООУ «Ассоциация «ЛУЧ», 
                ...
                <Member
                    image="kur"
                    text="член Правления, директор школы №9 города Перми, 
                    Почётный работник общего образования РФ"
                    alt="Курдина Наталья Анатольевна"
                />
                <Member
                    image="svy"
                    text="член Правления, начальник отдела «Художественное творчество» 
