...
export const TOP_NEWS_COVER = `${SERVER_URL}cover/Header3.webp`
export const TOP_NEWS_COVER_PC = `${SERVER_URL}cover/Header_PC.webp`
export const TOP_NEWS_COVER_TABLET = `${SERVER_URL}cover/Header_Tablet.webp`
export const TOP_NEWS_COVER_MOBILE = `${SERVER_URL}cover/Header_Mobile.webp`
export const TOP_NEWS_COVER_LITE = `${SERVER_URL}cover/lite/Header_lite.webp`
...
export const backgroundImageWithPhoto =
    "linear-gradient(rgba(255,255,255, 0) 50%, var(--color-dust-white) 70%)";
export const backgroundImageWithoutPhoto =
    "linear-gradient(rgba(255,255,255, 0) 50%, var(--color-dust-white) 95%)";